...
let zygoParseSpec = {
  ...
  bundlesJSON: { type: 'path' }, //path to bundles config
  ...
  environment: {default: 'development'}, //environment: can be development or production
  ...
  zygoHeader: { type: 'file', default: path.join(defaultsDir, 'zygoHeader.hb') },
  zygoFooter: { type: 'file', default: path.join(defaultsDir, 'zygoFooter.hb') },
  zygoBody: { type: 'file', default: path.join(defaultsDir, 'zygoBody.hb') }
};
